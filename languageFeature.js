(function () {
  const translations = {
    en: {
      ...
      settings: 'Settings',
      logout: 'Logout',
      featureTeamTitle: 'Team Creation',
      featureTeamDescription: 'Create a new team and add team members by name.',
      teamMembersTitle: 'Team Members',
      teamMembersDescription: 'View every team and the members assigned to it.',
      teamNameLabel: 'Team Name',
      teamHeadLabel: 'Team Head',
      teamHeadOneLabel: 'Team Head 1',
      teamHeadTwoLabel: 'Team Head 2',
      teamHeadThreeLabel: 'Team Head 3',
      ...
      teamHeadPlaceholder: 'Enter team head',
      ...
      settingsDescription: 'Manage general application preferences.',
      appearance: 'Appearance',
      appearanceDescription: 'Choose how Paisa Vasool looks on this device.',
      lightMode: 'Light',
      darkMode: 'Dark',
    },
    te: {
      ...
      logout: 'లాగ్అవుట్',
      featureTeamTitle: 'టీమ్ సృష్టి',
      featureTeamDescription: 'కొత్త టీమ్‌ను సృష్టించి ఆ పేరు ద్వారా సభ్యులను జోడించండి.',
      teamMembersTitle: 'టీమ్ సభ్యులు',
      teamMembersDescription: 'ప్రతి టీమ్ మరియు దానికి కేటాయించిన సభ్యులను చూడండి.',
      teamNameLabel: 'టీమ్ పేరు',
      teamHeadLabel: 'టీమ్ హెడ్',
      teamHeadOneLabel: 'టీమ్ హెడ్ 1',
      teamHeadTwoLabel: 'టీమ్ హెడ్ 2',
      teamHeadThreeLabel: 'టీమ్ హెడ్ 3',
      ...
      interest: 'వడ్డీ',
      totalAmount: 'మొత్తం',
      teamNamePlaceholder: 'టీమ్ పేరు నమోదు చేయండి',
      teamHeadPlaceholder: 'టీమ్ హెడ్ నమోదు చేయండి',
      ...
      confirmNewPassword: 'కొత్త పాస్వర్డ్ నిర్ధారణ',
      updatePassword: 'పాస్వర్డ్ నవీకరించండి',
      settingsTitle: 'సెట్టింగ్స్',
      settingsDescription: 'అప్లికేషన్ సాధారణ ఎంపికలను నిర్వహించండి.',
      appearance: 'కనిపించే విధానం',
      appearanceDescription: 'ఈ పరికరంలో పైసా వసూల్ ఎలా కనిపించాలో ఎంచుకోండి.',
      lightMode: 'లైట్',
      darkMode: 'డార్క్',
    },
    hi: {
      ...
      settings: 'सेटिंग्स',
      logout: 'लॉग आउट',
      featureTeamTitle: 'टीम निर्माण',
      featureTeamDescription: 'नई टीम बनाएं और नाम से सदस्यों को जोड़ें।',
      teamMembersTitle: 'टीम सदस्य',
      teamMembersDescription: 'हर टीम और उसमें शामिल सदस्यों को देखें।',
      teamNameLabel: 'टीम का नाम',
      teamHeadLabel: 'टीम हेड',
      teamHeadOneLabel: 'टीम हेड 1',
      teamHeadTwoLabel: 'टीम हेड 2',
      teamHeadThreeLabel: 'टीम हेड 3',
      ...
      teamHeadPlaceholder: 'टीम हेड दर्ज करें',
      ...
      settingsDescription: 'ऐप की सामान्य प्राथमिकताएं प्रबंधित करें।',
      appearance: 'दिखावट',
      appearanceDescription: 'इस डिवाइस पर पैसा वसूल का रूप चुनें।',
      lightMode: 'लाइट',
      darkMode: 'डार्क',
    },
  };
