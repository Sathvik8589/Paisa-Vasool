(function () {
  const AuthFeature = {
    ...
    bind({ loginForm, signupForm, signupBtn, backToLoginBtn, authMessage, loginInput, passwordInput, signupUsername, signupPassword, signupConfirmPassword, signupMobile, signupTeamName }) {
      this.elements = {
        loginForm,
        signupForm,
        signupBtn,
    ...
    setHandlers({ onLogin, onSignup, onShowSignup, onShowLogin }) {
      const { loginForm, signupForm, signupBtn, backToLoginBtn, loginInput, passwordInput, signupUsername, signupPassword, signupConfirmPassword, signupMobile, signupTeamName } = this.elements;
      ...
      signupForm?.addEventListener('submit', async (event) => {
        ...
        await onSignup({ username, password, confirmPassword, mobileNumber, teamName });
      });
    },
